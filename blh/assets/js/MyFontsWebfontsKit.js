...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/277d11';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"VektaSerif","fontWeight":"normal","fontStyle":"normal","url":wfpath+"277D11_0"+suffix+"_0."+webfontType},{"fontFamily":"VektaSerif-BoldItalic","url":wfpath+"277D11_1"+suffix+"_0."+webfontType},{"fontFamily":"VektaSerif","fontWeight":"bold","fontStyle":"normal","url":wfpath+"277D11_2"+suffix+"_0."+webfontType},{"fontFamily":"VektaSerif","fontWeight":"normal","fontStyle":"italic","url":wfpath+"277D11_3"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="format(\"svg\")";}
